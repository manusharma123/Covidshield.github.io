...
if($_SERVER['REQUEST_METHOD'] == "POST")
    ...
    $id = $_SESSION['id'];
		if(!empty($adhar) && !empty($cstatus) )
		{
            ...
            $query="UPDATE `user_table` SET addhar_number='$adhar',RTPCR='$cstatus' WHERE id = '$id' ";
 ...
 <div class='container'>
        <form id='form' class='form' method="post">
            ...
            <div class='form-control'>
                ...
                <input type='text' id='email' name="address" value="<?php echo $user_data['address']; ?>"placeholder='<?php echo $user_data['address']; ?>'disabled>
                <small>Error Message</small>
            </div>
            <div class='form-control'>
                <label for='email'>Adhar Number</label>
                <input type='text' id='email' name="addharnumber" placeholder='Enter Adhar Number'>
                <small>Error Message</small>
            </div>
            <div class='form-control'>
            <label for='email'>RTPCR</label>
